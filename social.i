...
%module(target_namespace="social") social
...
//
%ignore wrapper::social::NativeShare::init;
%ignore wrapper::social::NativeShare::getInstance;
%ignore wrapper::social::NativeShare::getListener;
%ignore wrapper::social::NativeShare::setListener;
%ignore wrapper::social::TournamentController::init;
%ignore wrapper::social::TournamentController::getInstance;
%ignore wrapper::social::TournamentController::getListener;
%ignore wrapper::social::TournamentController::setListener;
%ignore wrapper::social::ScheduledNotification::init;
